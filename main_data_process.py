...
if __name__ == '__main__':
    ...
    data_align.DataAlign.thick_first_second(thickness_datas_first_1912, data_path.filepath_thick_second_1912, 3000.0, data_path.filepath_thick_processed_all, 295.5)
    data_align.DataAlign.thick_first_second(thickness_datas_first_0942, data_path.filepath_thick_second_0942, 300.0, data_path.filepath_thick_processed_all, 72.0)
    data_align.DataAlign.thick_first_second(thickness_datas_first_1221, data_path.filepath_thick_second_1221, 5000.0, data_path.filepath_thick_processed_all, 54.0)
    data_align.DataAlign.thick_first_second(thickness_datas_first_1222, data_path.filepath_thick_second_1222, 5000.0, data_path.filepath_thick_processed_all, 30.0)
    data_align.DataAlign.thick_first_second(thickness_datas_first_2432, data_path.filepath_thick_second_2432, 3000.0, data_path.filepath_thick_processed_all, 39.5)
    data_align.DataAlign.thick_first_second(thickness_datas_first_1772, data_path.filepath_thick_second_1772, 2000.0, data_path.filepath_thick_processed_all, 66.0)
    ...
    datarw.data_writing_head_back(processed_data_1222, data_path.filepath_thick_processed_head, data_path.filepath_thick_processed_back)
    datarw.data_writing_head_back(processed_data_2432, data_path.filepath_thick_processed_head, data_path.filepath_thick_processed_back)
    datarw.data_writing_head_back(processed_data_1772, data_path.filepath_thick_processed_head, data_path.filepath_thick_processed_back)
    datarw.data_writing_head_back(processed_data_1431, data_path.filepath_thick_processed_head, data_path.filepath_thick_processed_back)
    datarw.data_writing_head_back(processed_data_1432, data_path.filepath_thick_processed_head, data_path.filepath_thick_processed_back)